...
const Signup = () => {
    ...
    return (
        <div className='container w-50 mx-auto'>
            <h1 className='text-warning text-center my-3'>Please Sign up</h1>
            ...
            <p className='mt-2 text-center'>Already have an account? <Link to='/login' className='text-warning pe-auto text-decoration-none'>Please Login</Link></p>
